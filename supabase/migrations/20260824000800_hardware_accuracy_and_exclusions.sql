-- ===========================================================================
-- 20260824000800: Hardware-accurate discovery defaults + stricter filters
-- User feedback: was getting pure gamers (no desk), only Shorts, and Indian
-- creators. This updates defaults for NEW users and optionally upgrades
-- existing users who never customized.
-- ===========================================================================
