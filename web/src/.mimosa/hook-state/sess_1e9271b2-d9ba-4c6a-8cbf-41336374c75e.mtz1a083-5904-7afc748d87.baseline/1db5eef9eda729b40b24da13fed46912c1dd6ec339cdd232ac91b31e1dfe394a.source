...
export function CreatorsPage() {
  ...
  return (
    <div>
      ...
      {/* Hidden: discovery/search volume banner removed — add creators manually or via bulk import. Code preserved in git history. */}
  ...
  return (
    <div>
      ...
      <PageHeader title={c.name} subtitle={c.contact_email || undefined}>
        {/* Hidden but preserved: Outreach link (FEATURES.outreachEnabled) */}
