export type Theme = 'agency' | 'light' | 'dark' | 'honey' | 'ocean'
...
// Rows created before reach-backs became a single status may still carry these.
export const LEGACY_REACH_BACK: Record<string, PipelineStatus> = {
  reach_back_1: 'reach_back',
  reach_back_2: 'reach_back',
  reach_back_3: 'reach_back',
}

export function normalizeStatus(s: string): PipelineStatus {
  return LEGACY_REACH_BACK[s] || (s as PipelineStatus)
}
...
export const STATUS_LABELS: Record<string, string> = {
  ...
  // legacy rows normalize to 'reach_back' — kept so nothing ever shows raw keys
  reach_back_1: 'Reach back',
  reach_back_2: 'Reach back',
  reach_back_3: 'Reach back',
  replied: 'Replied',
