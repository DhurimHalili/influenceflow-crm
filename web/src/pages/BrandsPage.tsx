...
export function BrandsPage() {
  ...
  async function load() {
    ...
    // normalize legacy reach_back_1/2/3 rows to the single reach_back status
    setRows(((data || []) as Brand[]).map((r) => ({ ...r, pipeline_status: normalizeStatus(r.pipeline_status) })))
  }
...
export function BrandDetailPage() {
  ...
  async function load() {
    ...
    setBrand(b ? ({ ...b, pipeline_status: normalizeStatus((b as Brand).pipeline_status) } as Brand) : null)
    setPeople(((p || []) as BrandContact[]).map((r) => ({ ...r, pipeline_status: normalizeStatus(r.pipeline_status) })))
  }
